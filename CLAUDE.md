...
- **De la Edi, pe lângă verificarea pe Genos**: GIF-ul de 15 secunde și videoul de 60–90 s pentru README (comentariul `<!-- demo.gif -->` marchează locul), domeniul `sidekeys.app`, confirmarea generalizării regulii de anticipare. **Apoi**: prototipul de microfon cu `basic-pitch-ts`, în afara lui `src/`. **La P2, nu acum**: opinie de marcă pe familia „Sidekick" în clasele 9 și 41, înainte de înregistrare.
