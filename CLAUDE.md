...
1. **Acordurile anticipate în timed**, de decis cu Edi: schimbarea de slot să nu mai anuleze captura, iar un voicing început cu puțin înainte de schimbare (cât: o optime?) să conteze pentru acordul următor. Apoi reparat test-first și verificat pe sesiunile înregistrate (cele cu anticipări apar ca `changed`/`extra`, acceptate cu `--update` după ce Edi le vede).
