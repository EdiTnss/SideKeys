...
Brandul e legat. Înainte de orice link trimis cuiva: **banda de clape din `og-image.png` repictată** în claude.ai/design cu verdictul verificat (G7: B3 verde, F4 verde, A4 albastru, Eb5 violet, F#5 roșu, fără gri), Apoi **GIF-ul de 15 secunde și videoul de 60–90 s** pentru README (filmate de Edi), apoi **prototipul de microfon** cu `basic-pitch-ts`. Pe listă la P2, nu acum: opinie de marcă pe familia „Sidekick" în clasele 9 și 41, înainte de înregistrare.
