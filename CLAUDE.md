...
src/
  ...
  theory/analyzer.js       clasifică voicing-ul, low interval limits, voice leading
  theory/progressions.js   biblioteca de progresii generice
