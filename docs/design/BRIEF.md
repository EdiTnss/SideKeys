...
> The keyboard strip in `og-image.png` was repainted the same day so that every coloured key is
> the verdict the app itself gives (see `docs/JOURNAL.md`, 2026-09-22).
